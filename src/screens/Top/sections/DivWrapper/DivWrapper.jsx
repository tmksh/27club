        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8" data-scroll="fade-up">
          ...
          >
            ...
            <div className="mb-4 lg:mb-10">
              ...
              <div className="[font-family:'Noto_Sans_JP',Helvetica] text-white space-y-1.5 lg:space-y-3">
            ...
            <div className="pt-3 lg:pt-8 border-t border-white/10">
              <p className="[font-family:'Noto_Sans_JP',Helvetica] text-white/50 text-[10px] lg:text-base leading-relaxed">
                {t('access.notice')}
              </p>
            </div>
          </div>
