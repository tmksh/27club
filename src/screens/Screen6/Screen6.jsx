...
export const Screen6 = () => {
  return (
    <div
      className="flex flex-col items-center justify-center gap-[94px] relative overflow-hidden bg-[url(/img/27-background.png)] bg-repeat-y bg-[50%_0%] md:min-w-[1440px]"
