...
export const Frame14 = () => {
  ...
  const stepsJa = [
    ...
    },
    {
      ...
      description: (
        <>
          拍手・声援 → 感動したら素直に！チップ → 「もっと応援したい！」と思ったらキャストへ。10枚（1,200円）から購入可能。
          <br /><br />
    ...
    },
    {
      ...
      description: (
        <>
          ショーが終わっても、キャストと言葉を交わしたり、一緒に写真を撮ったりドリンクを片手に、この余韻をもう少し。
        </>
      ),
      ...
      >
        ...
        <div className="flex flex-col gap-2 w-full items-center">
          <div className="[font-family:'Noto_Sans_JP',Helvetica] font-bold text-[#cccccc] text-xs md:text-base text-center leading-relaxed">
            {language === 'ja' ? (
              <>
                THE27CLUBのショーは、キャストとお客様が一体となって作り上げるもの。<br className="hidden md:inline" />拍手も、声援も、チップも、撮影も、フードやドリンクもそのすべてがショーの一部です。
              </>
            ) : (
              <>
