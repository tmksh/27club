...
export const translations = {
  ja: {
    ...
    aboutStudioRental: {
      ...
      pricingTitle: '料金体系',
      pricingNote: '※料金は目安です。詳細はお問い合わせください。',
      pricingItems: [
        { label: '平日（1時間〜）', price: 'お問い合わせください' },
        { label: '土日祝（1時間〜）', price: 'お問い合わせください' },
        { label: '終日貸切', price: 'お問い合わせください' },
      ],
  ...
  en: {
    ...
    aboutStudioRental: {
      ...
      pricingNote: '*Prices are approximate. Please contact us for details.',
      pricingItems: [
        { label: 'Weekdays (from 1 hour)', price: 'Please inquire' },
        { label: 'Weekends & Holidays (from 1 hour)', price: 'Please inquire' },
        { label: 'Full Day Rental', price: 'Please inquire' },
      ],
